...
@section('content')
    <div class="header_line">
        ...
        <ul class="tab-base">
            ...
            <li><a href="{{url('admin/douban/tags/create')}}"><span>添加标签</span></a></li></ul>
    </div>
            ...
            <table class="table tb-type2 nobdb">
                ...
                @forelse($list as $value)
                    <tr class="hover" style="background: rgb(255, 255, 255);">
                        ...
                        <td class="align-center">
                            <a href="{{url('admin/douban/tags/edit?id=')}}{{$value->id}}">编辑</a> |
                            <a href="JavaScript:void(0)" deleteId="{{$value['id']}}" deleteUrl="{{url('admin/douban/tags/del')}}" class="delete">删除</a></td>
                    </tr>
                ...
                <tr>
                    ...
                    <td colspan="16"><label for="checkallBottom">全选</label>&nbsp;&nbsp;
                        <a href="JavaScript:void(0);" class="btn delAll" deleteUrl="{{url('admin/douban/tags/del')}}"><span>删除</span></a>
