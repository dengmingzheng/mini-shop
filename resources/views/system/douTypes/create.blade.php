...
@section('content')
    <div class="header_line">
        ...
        <ul class="tab-base">
            ...
            <li><a class="current"><span>添加类型</span></a></li>
        </ul>
    </div>

    <div class="content-group">
        <form method="POST" action="{{url('admin/douban/types/create')}}" id="form">
            @csrf

            <table class="table tb-type2">
                <tbody>
                <tr class="noborder">
                    <td colspan="2"><label class="validation">类型名称(必填):</label></td>
                </tr>
                <tr class="noborder">
